...
int main(int argc, char *argv[]){
    ...
    */
    ...
    int loop_count = 0;
    bool ff = false;
    int atom_push_count = 0;
    while (!(push_between_ihi.empty()))
    {
        loop_count++;
        // if(loop_count % 50000000 == 0 || loop_count == 1000000){
        //     ff = true;
        // }
        ...
        // if(ff){
        //     cout << distance_ihhi1[arg2].size() << "," << distance_ihhi2[arg2].size() << endl;
        //     ff = false;
        // }
    ...
    o_file << duration << "," << d1 << "," << d2 << "," << d3 << "," << loop_count << "," << atom_push_count << endl;
