...
// delfirst path アトムが消える可能性があるルールを試すとき、
// p_path の中のアトムにもマッチングをためす
                            ...
                            if(get<1>(**k) == B){
                                ...
                                if(R > 0){
                                    if(history_rule2.insert({tmp,B}).second){
                                        ...
                                        auto nitr = prev(p_path.end());
                                        vec_p_path[tmp].push_back(nitr);
                                    }
                                }
                            }
                        }
                            ...
                            if(get<1>(**j) == B){
                                ...
                                if(R > 0){
                                    if(history_rule3.insert({arg3,H,B}).second){
                                        ...
                                        auto nitr = prev(p_path.end());
                                        vec_p_path[arg3].push_back(nitr);
                                    }
                                }
                            }
                        }
